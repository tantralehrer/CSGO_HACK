...
enum Hitboxes
{
	...
	HITBOX_LEFT_FOOT,
	HITBOX_RIGHT_HAND,
	HITModelRenderInfo_tBOX_LEFT_HAND,
...
struct studiohdr_t
{
	...
	inline mstudioanimdesc_t *pLocalAnimdesc(int i) const { return nullptr; };

	int					numlocalseq;				// sequences
	int					localseqindex;
	inline mstudioseqdesc_t *pLocalSeqdesc(int i) const { return nullptr; };
	...
	int					numtextures;
	int					textureindex;
	inline mstudiotexture_t *pTexture(int i) const { return nullptr; };
	...
	int					numbodyparts;
	int					bodypartindex;
	inline mstudiobodyparts_t	*pBodypart(int i) const { return nullptr; };
};
